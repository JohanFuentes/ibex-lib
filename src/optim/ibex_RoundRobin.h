#ifndef __IBEX__ROUNDROBIN_H__
#define __IBEX__ROUNDROBIN_H__
...
protected:
    ...
    int option; // Option to select the action 

public:

    RoundRobin(CellBeamSearch * buffer, int num_actions, double size_step);
